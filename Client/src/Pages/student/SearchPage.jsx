...
const CourseNotFound = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-32 bg-gray-100 p-6 rounded-md">
      <AlertCircle className="text-red-500 h-16 w-16 mb-4" />
      <h1 className="font-bold text-2xl md:text-4xl text-gray-800 mb-2">Course Not Found</h1>
      <p className="text-lg text-gray-600 mb-4">Sorry, we couldn't find the course you're looking for.</p>
...
const CourseSkeleton = () => {
  return (
    <div className="flex-1 flex flex-col md:flex-row justify-between border-b border-gray-300 py-4 animate-pulse">
      <div className="h-32 w-full md:w-64 bg-gray-300 rounded-md" />
      <div className="flex flex-col gap-2 flex-1 px-4">
        ...
        <div className="h-6 w-20 mt-2 bg-gray-300 rounded-md" />
      </div>
